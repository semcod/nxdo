...
- **Calls**: retry, LLMAPIError, src.nxdo.koru_context.get_koru_system_prompt_extension, os.getenv, os.getenv, httpx.Client, client.post, src.nxdo.providers.openai_compat._extract_error_detail
...
- **Calls**: app.command, typer.Argument, typer.Option, typer.Option, examples.check-examples.print, Path, src.nxdo.cli._render_prompt_text
...
### examples.check-examples.fail

### examples.check-examples.pass

### examples.check-examples.require_file
...
- `examples.check-examples.print` - 0 calls
